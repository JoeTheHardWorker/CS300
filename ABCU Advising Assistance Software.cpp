...
//global variables
//============================================
int userChoice(0); //menu selection variable
//============================================
...
void loadCourse(string inputFile, vector<Course>& courses) {
...
int main()
{
    ...
    while (userChoice != 9)
    {
        ...
        case 1:
            ...
            cin.ignore();
            cin >> inputFile;
            loadCourse(inputFile, courses);
            break;
        case 2:
            if (courses.empty()) {
                cout << "No courses found. Remember to load the course file!" << endl;
            }
            else if (!courses[0].getCourseId().empty()) {
        ...
        case 9:
            exit(0);
        default:
            cout << userChoice << "not a valid option" << endl;
            cin.clear();
